...
Feature.create([
	...
	{name: 'tundra', description: 'In physical geography, tundra is a type of biome where the tree growth is hindered by low temperatures and short growing seasons. There are three types of tundra: Arctic tundra, alpine tundra, and Antarctic tundra. In tundra, the vegetation is composed of dwarf shrubs, sedges and grasses, mosses, and lichens. Scattered trees grow in some tundra regions. The ecotone (or ecological boundary region) between the tundra and the forest is known as the tree line or timberline.'},
...
460.times do
	Order.create(price: rand(1000..8000), size: rand(50..8000000), feature_id: rand(1..15), planet_id: rand(1..35))
end
